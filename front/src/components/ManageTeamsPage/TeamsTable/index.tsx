...
import { useGetOwnTeamsQuery } from '../../../features/api/apiSlice';
...
const AllTeamsTable = () => {
  ...
  const { data: teamsRes, refetch, isLoading, isFetching } = useGetOwnTeamsQuery();
                  ...
                  <TableRow
                    ...
                    <TableCell component="th" scope="row">
                      {team.inLeague ? (
                        team.approved ? (
                          <p>
                            {team.leagueNumber}. {t('manageTeamsPage.AllTeamsTable.team_league')}
                          </p>
                        ) : (
                          <>
                            <p>
                            ...
                            <p>{t('manageTeamsPage.AllTeamsTable.waiting_for_approval')}</p>
                          </>
                        )
                      ) : (
                        <p>{t('manageTeamsPage.AllTeamsTable.team_not_in_league')}</p>
                      )}
                    </TableCell>
                  </TableRow>
                ))}
